...
fun OnBoardingHeightScreen(
    ...
    Box(modifier = modifier) {
        ...
        Image(imageVector = ImageVector.vectorResource(R.drawable.glaciermizu), contentDescription ="Glacier Background",modifier= Modifier.align(
            Alignment.Center).size(500.dp),)
        Column(
...
@Composable
fun PreviewOnBoardingHeightScreen() {
    var heightValue by remember {
        mutableIntStateOf(0)
    }
    OnBoardingHeightScreen(getWeightChange = {
        if (it != null) {
            heightValue = it
        }
    }, onWeightChange = heightValue, onUserName = "Hitesh", getNavigate = {
